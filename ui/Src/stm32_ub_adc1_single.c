...
ADC1s_t ADC1s[] = {
 ...
 // {ADC_PA01 ,GPIOA,GPIO_PIN_0,ADC_CHANNEL_0,MW_321},   // ADC an PA0 = ADC123_IN0
...
uint8_t retv;
 ...
 if (HAL_ADC_GetState(&Adc1Handle) != HAL_ADC_STATE_EOC_REG) return 4;
 // if(HAL_IS_BIT_CLR(HAL_ADC_GetState(&Adc1Handle), HAL_ADC_STATE_REG_EOC)) return 4;
  // Messwert auslesen
